...
**Recommended Citation:**  Environmental Protection Agency (EPA). 2024. Technical Documentation on The Framework for Evaluating Damages and Impacts (FrEDI). EPA 430-R-24-001. Available:<a href="../../documentation/Technical_Documentation_for_FrEDI.pdf">here</a> <br>
...
**FrEDI is peer-reviewed and developed as an open-source R package.** This Framework and its <a href="../../documentation/Technical_Documentation_for_FrEDI.pdf">Technical Documentation</a> have been subject to a public review comment period and an independent external peer review, following guidance in the EPA Peer-Review Handbook for Influential Scientific Information (ISI). Information on the peer-review is available in the [EPA Science Inventory](https://cfpub.epa.gov/si/si_public_record_report.cfm?dirEntryId=351316&Lab=OAP&simplesearch=0&showcriteria=2&sortby=pubDate&searchall=fredi&timstype=&datebeginpublishedpresented=02/14/2021).
...
For details about each sector and the underlying damage functions, see the <a href="../../documentation/Technical_Documentation_for_FrEDI.pdf">Technical Documentation</a>
