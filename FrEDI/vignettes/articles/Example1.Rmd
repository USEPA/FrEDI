...
*Note: Use the `sectorprimary ==1` and `includeaggregate >=1` flags to filter the `FrEDI` dataframe for impacts from only the default impact sectors and variants. For recommendations on aggregating impacts across sectors, 
see the FrEDI Technical Documentation (Chapter 2) and FrEDI::run_fredi() documentation. 
