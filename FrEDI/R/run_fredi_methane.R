...
#' * __Ozone__. The ozone default scenario, `o3Default`, uses state- and model-specific constant values for change in ozone concentration (`O3_pptv` in pptv) for the years 2020 through 2100, as calculated from the default methane and NOx scenarios using the approach described above.
#'
