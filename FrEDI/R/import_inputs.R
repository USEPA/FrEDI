...
#'
#' @param tempfile A character string indicating the location of a CSV file containing a custom temperature scenario (first column contains years in the interval 2000 to 2300 (values must start in 2000 or earlier); second column contains temperatures, in degrees Celsius, above the 1995 baseline).
#' @param slrfile A character string indicating the location of a CSV file containing a custom sea level rise scenario (first column contains years in the interval 2000 to 2300 (values must start in 2000 or earlier); second column contains values for global mean sea level rise (GMSL), in centimeters, above the 2000 baseline).
...
#' @param gdpfile A character string indicating the location of a CSV file containing a custom scenario for gross domestic product (GDP) (first column contains years in the interval 2010 to 2300; second column contains values for GDP, in total 2015$).
