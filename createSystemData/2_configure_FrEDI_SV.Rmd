...
c_sv_sectors     <- c("Air Quality - Premature Mortality") #put rest of sectors here
```
...
#resultsPath <- "G:/Share/CIRA_Synthesis/03 Temperature Binning/RTool/analysis/20221025_newAQ_sv_qc"
```
