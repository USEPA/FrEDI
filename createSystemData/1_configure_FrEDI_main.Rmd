...
```{r mostRecentDate}
mostRecentDate <- "20230403"
# mostRecentDate <- "20230303_vibrio"
```
...
### Examine Default Results

```{r examine FrEDI defaults}
# this is not a defined function currently
test1 %>% general_output_test(
  outPath   = ".",
  save      = TRUE,
  return    = TRUE,
  overwrite = TRUE
