...
```{r test_systemData0}
test_systemData0 <- list_systemData0[-length(list_systemData0)] %>% dataInfo_test(
...
test_general_config <- general_config_test(
  reshapedData   = list_reshapeData[-length(list_reshapeData)],
  configuredData = list_systemData0[-length(list_systemData0)],
  overwrite      = TRUE,
...
test_systemData0 <- newSectors_config_test(
    newData = list_systemData0,
    # refDataFile = projectPath %>% file.path("createSystemData", "data", "sysdata.rda"),
