...
FrEDI is an open-source, reduced form model that rapidly projects the impacts within the United States, under any custom temperature. 
...
FrEDI is continually developed and currently draws upon over 30 existing peer-reviewed studies, including from the [Climate Change Impacts and Risk Analysis (CIRA)](https://www.epa.gov/cira/) project, to estimate the relationship between  degrees of warming and impacts across more than 20 category sectors, 48 U.S. states plus the District of Columbia, and population groups. When supplied with a user-defined temperature trajectory, FrEDI then applies these temperature-impact relationships to rapidly project annual impacts and damages through the end of the 21st century (optionally through the year 2300).
<br>
