...
p_national_damages <- df_filter %>%
  ...
  labs(subtitle="Absolute Annual U.S. Climate-Driven Damages",
...
kable(table1, caption = 'National Total Damages by Sector')
#formattable(table1, align = c("l","l","l","l"),
#                        format = 'f')
